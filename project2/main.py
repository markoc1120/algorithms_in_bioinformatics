...
def parse_args():
    ...
    parser.add_argument("--seq1", type=str, required=True, help="First sequence")
    parser.add_argument("--seq2", type=str, required=True, help="Second sequence")
    parser.add_argument(
        "--gap-model",
        choices=["linear", "affine"],
        default="linear",
        help="Gap penalty model to use (default: linear)",
    )
